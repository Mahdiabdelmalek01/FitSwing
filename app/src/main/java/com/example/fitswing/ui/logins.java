    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goResgister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(logins.this, setup_profil.class);
        ...
        authProfile.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(logins.this, "Logged in Successfully", Toast.LENGTH_LONG).show();
                        // Navigate to HomeFragment
                        navigateToHomeFragment();
                    } else {
                        // If sign in fails, display a message to the user.
                        Toast.makeText(logins.this, "Failed to login: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
